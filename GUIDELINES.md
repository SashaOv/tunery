...
- For pull requests, include: summary of changes, reproduction or test instructions (`uv run pytest` output), linked issues, and screenshots or sample YAML if UX changes affect the CLI output.
